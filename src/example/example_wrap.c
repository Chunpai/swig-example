...
extern "C" {
#endif
SWIGINTERN int Swig_var_value_set(PyObject *_val) {
  {
    double val;
    int res = SWIG_AsVal_double(_val, &val);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in variable '""value""' of type '""double""'");
    }
    value = (double)(val);
  }
  return 0;
...
SWIGINTERN PyObject *Swig_var_value_get(void) {
  ...
  pyobj = SWIG_From_double((double)(value));
  return pyobj;
}
